# github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-control-api
...
```sh
go get github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-control-api
...
import (
	...
	api "github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-control-api"
)
...
func main() {
	client := api.NewTallyOwlControlClient(&HTTPRpcCarrier{BaseURL: "http://localhost:5080"})
	resp, err := client.RunQuery(context.Background(), api.QueryRequest{AlgebraVersion: 0, AllowPartial: false})
	if err != nil {
		panic(err)
	}
	fmt.Printf("%+v\n", resp)
...
func runDatagrams(carrier transport.DatagramCarrier) error {
	req := api.QueryRequest{AlgebraVersion: 0, AllowPartial: false}
	// seq 0 marks an unsequenced datagram.
	datagram, err := transport.NewDatagram(opOrd, 0, api.EncodeQueryRequest(req)).Encode()
	if err != nil {
		return err
	}
	...
	if inbound != nil {
		...
		resp, err := api.DecodeQueryResponse(dg.Payload)
		if err != nil {
			return err
		}
