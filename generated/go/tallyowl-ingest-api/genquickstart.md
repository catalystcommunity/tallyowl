# github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-ingest-api
...
```sh
go get github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-ingest-api
...
import (
	...
	api "github.com/CatalystCommunity/tallyowl/generated/go/tallyowl-ingest-api"
)
...
func main() {
	client := api.NewTallyOwlIngestClient(&HTTPRpcCarrier{BaseURL: "http://localhost:5080"})
	resp, err := client.Capture(context.Background(), api.CaptureRequest{})
	if err != nil {
		panic(err)
	}
	fmt.Printf("%+v\n", resp)
...
func runDatagrams(carrier transport.DatagramCarrier) error {
	...
	datagram, err := transport.NewDatagram(opOrd, 0, api.EncodeCaptureRequest(req)).Encode()
	if err != nil {
		return err
	}
	...
	if inbound != nil {
		...
		resp, err := api.DecodeCaptureResponse(dg.Payload)
		if err != nil {
			return err
		}
