...
export function validateDeliveryTask(value: DeliveryTask): string[] {
  const errors: string[] = [];
...
export function validateResolveKeyRequest(value: ResolveKeyRequest): string[] {
  const errors: string[] = [];
  if (value.credential.length < 1 || value.credential.length > 512) errors.push("credential: length must be between 1 and 512");
  return errors;
}

export function validateResolveKeyResponse(value: ResolveKeyResponse): string[] {
  const errors: string[] = [];
  if (value.keyId.length < 1 || value.keyId.length > 64) errors.push("keyId: length must be between 1 and 64");
  return errors;
}

export function validateTailRule(value: TailRule): string[] {
  const errors: string[] = [];
  if (value.name.length < 1 || value.name.length > 128) errors.push("name: length must be between 1 and 128");
  return errors;
}

export function validateProtectedKey(value: ProtectedKey): string[] {
  const errors: string[] = [];
